...
import { Search, RefreshCw, ChefHat, CheckCircle, Clock, XCircle, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto animate-fade-in space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight font-serif">Kitchen Dashboard</h1>
      ...
      {/* Bottom row - Kitchen Status only */}
      <div className="grid grid-cols-1">
        <Card className="border-none shadow-sm shadow-green-100/50 bg-gradient-to-br from-green-800 to-green-900 text-white overflow-hidden relative">
